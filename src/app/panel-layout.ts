    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
          ...
          <img src="/qualtron-logo.svg" class="logo-emblem" alt="Qualtron" width="24" height="24" /><span class="logo">MONITOR</span><span class="logo-mobile">World Monitor</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          <img src="/qualtron-logo.svg" alt="Qualtron" width="28" height="28" loading="lazy" decoding="async" class="site-footer-icon" />
