...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'World Monitor by Qualtron - Real-Time Global Intelligence Dashboard',
    description: 'Real-time global intelligence platform by Qualtron. Conflicts, markets, military, OSINT in one view — with Qulatron AI to interrogate the data.',
    ...
    url: 'https://qgi.qualtron.world/dashboard',
    siteName: 'World Monitor by Qualtron',
  ...
  tech: {
    ...
    url: 'https://tech.qualtron.world/dashboard',
    siteName: 'Tech Monitor by Qualtron',
  ...
  happy: {
    ...
    url: 'https://happy.qualtron.world/dashboard',
    siteName: 'Happy Monitor by Qualtron',
  ...
  finance: {
    ...
    url: 'https://finance.qualtron.world/dashboard',
    siteName: 'Finance Monitor by Qualtron',
  ...
  commodity: {
    ...
    url: 'https://commodity.qualtron.world/dashboard',
    siteName: 'Commodity Monitor by Qualtron',
  ...
  energy: {
    ...
    url: 'https://energy.qualtron.world/dashboard',
    siteName: 'Energy Atlas by Qualtron',
