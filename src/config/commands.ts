...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:chat-analyst', keywords: ['qulatron', 'wm analyst', 'analyst', 'ai analyst', 'chat analyst', 'ask ai', 'intelligence analyst'], label: 'Panel: Qulatron', icon: '\u{1F916}', category: 'panels' },
